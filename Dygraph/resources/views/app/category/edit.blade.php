                ...
                <div class="card">
                    ...
                    <div class="card-body foto-upload">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div id="image-preview" class="image-preview" style="background: url('{{ asset('UploadedFile/img_category/'.$categories->img_category) }}'); background-size: cover; background-repeat: no-repeat;">
                                    <label for="image-upload" id="image-label">Change File</label>
                                    <input type="file" name="img_category" id="image-upload"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="category" required="" value="{{ $categories->category }}">
