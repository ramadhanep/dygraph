...
<section class="section">
    ...
    <div class="row">
        <form method="POST" action="{{ route('manajemenUserSave') }}" enctype="multipart/form-data" class="needs-validation" novalidate="" style="width: 100%;display: flex;flex-wrap:wrap;">
            @csrf
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div id="image-preview" class="image-preview">
                                    ...
                                    <input type="file" name="profile" id="image-upload" required/>
                                </div>
                            </div>
                        </div>
                    </div>
